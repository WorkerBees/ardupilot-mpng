...
/**
   HAL MPNG sub-types
 */
#define HAL_BOARD_SUBTYPE_MPNG_RCTIMER_CRIUS_V2          3
#define HAL_BOARD_SUBTYPE_MPNG_CRIUS_V1                  4
#define HAL_BOARD_SUBTYPE_MPNG_HK_RED_MULTIWII_PRO       5
#define HAL_BOARD_SUBTYPE_MPNG_BLACK_VORTEX              6
#define HAL_BOARD_SUBTYPE_MPNG_MULTIWII_PRO_EZ3_BLACK    7
#define HAL_BOARD_SUBTYPE_MPNG_PARIS_V5_OSD              8
...
#define HAL_STORAGE_SIZE            4096
#define HAL_STORAGE_SIZE_AVAILABLE  HAL_STORAGE_SIZE
#if CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_MPNG_HK_RED_MULTIWII_PRO || CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_MPNG_BLACK_VORTEX
 # define HAL_INS_DEFAULT   HAL_INS_ITG3200
 # define HAL_BARO_DEFAULT  HAL_BARO_BMP085
#elif CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_MPNG_PARIS_V5_OSD
 # define HAL_INS_DEFAULT   HAL_INS_ITG3200
 # define HAL_BARO_DEFAULT  HAL_BARO_MS5611
#else
 # define HAL_INS_DEFAULT   HAL_INS_MPU6000_I2C
 # define HAL_BARO_DEFAULT  HAL_BARO_MS5611
#endif
#define HAL_COMPASS_DEFAULT HAL_COMPASS_HMC5843
